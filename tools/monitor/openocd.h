...
extern int openocd_read_memory(int socket, uint64_t address, void *buffer, size_t length);
extern int openocd_write_memory(int socket, uint64_t address, const void *buffer, size_t length);
